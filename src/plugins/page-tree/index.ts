          ...
          if ('name' in field && field.name === 'slug' && field.type === 'text') {
            ...
            return {
              ...
              admin: {
                ...textField.admin,
                readOnly: true,
                description: buildSlug
                  ? 'Auto-generated by custom buildSlug function'
      ...
      config.admin = {
        ...
        components: {
          ...
          afterNavLinks: [
            ...
            '@/plugins/page-tree/exports/client#PageTreeNavLink',
          ],
          // Add custom view (server component)
          views: {
            ...config.admin?.components?.views,
            pageTree: {
              Component: '@/plugins/page-tree/exports/rsc#PageTreeView',
