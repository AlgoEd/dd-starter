        ...
        {isFolder ? (
          <>
            ...
            <MenuItem
              ...
              onClick={() => onAction('regenerateSlugs')}
            >
              Regenerate URLs
            </MenuItem>
            <MenuDivider />
          ...
          <>
            ...
            >
              {puckEnabled ? 'Edit with Visual Editor' : 'Edit'}
            </MenuItem>
            {puckEnabled && (
              <MenuItem
                icon={
                ...
                onClick={() => onAction('editInPayload')}
              >
                Edit in Payload
              </MenuItem>
            )}
