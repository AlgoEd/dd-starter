...
import {
  createColorField,
  createOptionalColorField,
  createPillField,
} from '@/components/puck/fields'
import {
  HERO_THEMES,
  DEFAULT_HERO_THEME,
  CTA_STYLES,
...
const rootConfig = {
  fields: {
    ...
    primaryBright: createOptionalColorField({
      label: 'Primary Bright (hero overlay, accents — optional)',
      emptyText: 'Using Primary Dark',
    }),
    heroTheme: {
    ...
    highlightOverride: createOptionalColorField({
      label: 'Override Highlight',
      emptyText: 'Using theme preset',
    }),
    ctaStyle: {
      type: 'select' as const,
