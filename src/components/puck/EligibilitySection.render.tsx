      ...
      <div className="px-3 md:px-5">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-5 md:gap-6">
            ...
            <div
              className="block md:hidden w-[383px] max-w-full h-[5px] my-2 rounded"
              style={{ backgroundColor: color }}
            />
            <div
              className="hidden md:block ml-3 rounded"
              style={{ width: '4px', height: '120px', backgroundColor: color }}
            />
