...
export interface LegacyBadgeItem {
  icon: MediaReference | null
  label: string
  sublabel: string
}

export interface LegacyAwardGroup {
  roundTitle: string
  subtitle: string
  badges: LegacyBadgeItem[]
  variant: 'default' | 'final'
}

export interface LegacySpecialAward {
  icon: MediaReference | null
  title: string
  description: string
}

export interface AwardsSectionLegacyProps {
  heading: string
  introText: string
  groups: LegacyAwardGroup[]
  specialAwards: LegacySpecialAward[]
  noteText: string
...
function getGroupCardStyle(group: LegacyAwardGroup): React.CSSProperties {
