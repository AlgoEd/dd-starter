...
export const CompetitionHeroConfig: ComponentConfig<CompetitionHeroProps> = {
  ...
  fields: {
    ...
    titleLine2: {
      type: 'text',
      label: 'Title Line 2 — highlighted (e.g. "SCIENCE & ENGINEERING")',
    },
    ...
    statusText: {
      type: 'text',
      label: 'Status Text (e.g. "Registration Open" or "Priority Registration Deadline")',
    },
    statusSubtext: {
      type: 'text',
      label: 'Status Subtext (e.g. "November 18, 2026" — leave empty for single line)',
    },
    ...
    overlayTopOpacity: createSliderField({
      label: 'Overlay Top Opacity (default 80%)',
      min: 0,
      max: 100,
      step: 5,
    }),
    overlayBottomOpacity: createSliderField({
      label: 'Overlay Bottom Opacity (default 100%)',
      min: 0,
      max: 100,
      step: 5,
    }),
    badgeStripHeading: {
      type: 'text',
      label: 'Badge Strip Heading (e.g. "Step into:" — leave empty to hide strip)',
    },
    badgeStripItems: {
      type: 'array',
